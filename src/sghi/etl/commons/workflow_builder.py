...
from .processors import NoOpProcessor, ScatterProcessor
from .sinks import NullSink, ScatterSink
from .sources import SourceSet
from .workflow_definitation import SimpleWorkflowDefinitions
...
class WorkflowBuilder(Generic[_RDT, _PDT]):
    """A builder of :class:`workflow definitions <WorkflowDefinition>`."""
    ...
    def build(self) -> WorkflowDefinition[_RDT, _PDT]:
        ...
        :return: A new ``WorkflowDefinition`` instance.
        """
        return SimpleWorkflowDefinitions(
            id=self.id,
            name=self.name,
